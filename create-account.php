...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        if($result->num_rows==1){
            ...
            $nidPhotoUploadPath = 'img/patient/' . $nidPhotoFileName;

            move_uploaded_file($nidPhotoTmpName, $nidPhotoUploadPath);

            $database->query("INSERT INTO patient(pemail, pname, ppassword, paddress, pnid, nid_photo, pdob, ptel) VALUES ('$email','$name','$newpassword','$address','$nid','$nidPhotoUploadPath','$dob','$tele')");
        ...
        <table border="0" style="width: 69%;">
            ...
            <tr id="doctor-fields">
                <td class="label-td" colspan="2">
                    <label for="certificate" class="form-label">Patient Nid: </label>
                </td>
            </tr>
            <tr id="doctor-fields">
                <td class="label-td" colspan="2">
