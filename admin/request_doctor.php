...
<div class="dash-body">
    <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
        <tr>
            <td>
                ...
                <form action="" method="post" class="header-search">
                    ...
                    $list11 = $database->query("SELECT docname, docemail FROM doctor WHERE is_active=0");
        ...
        if ($_POST) {
            ...
            $sqlmain = "SELECT * FROM doctor WHERE (docemail='$keyword' OR docname='$keyword' OR docname LIKE '$keyword%' OR docname LIKE '%$keyword' OR docname LIKE '%$keyword%') AND is_active=0";
        } else {
            $sqlmain = "SELECT * FROM doctor WHERE is_active=0 ORDER BY docid DESC";
        }
        ?>
                            ...
                            if ($result->num_rows == 0) {
                                ...
                                for ($x = 0; $x < $result->num_rows; $x++) {
                                    ...
                                    echo '<tr>
                                        ...
                                        <a href="?action=accept&id=' . $docid . '&error=0" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-edit"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Accept</font></button></a>
                                        &nbsp;&nbsp;&nbsp;
    ...
    if ($action == 'drop') {
        ...
        echo '
            <div id="popup1" class="overlay" style="overflow: auto">
                    ...
                    <center>
                        <h2></h2>
                        <a class="close" href="request_doctor.php">&times;</a>
                        <div class="content">
                            BD Doctor Aid<br>
        ...
        $sqlSelect = "SELECT * FROM doctor WHERE docid='$id'";
        $result = $database->query($sqlSelect);

        if ($result->num_rows > 0) {
            $sqlUpdate = "UPDATE doctor SET is_active = 1 WHERE docid='$id'";

            if ($database->query($sqlUpdate) === TRUE) {
                //header("location: ../request_doctor.php");
