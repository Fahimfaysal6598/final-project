                ...
                <tr>
                   <td style="padding:10px" colspan="3">
                       <center>
                        ...
                        <table id="schedule-table" width="100%" class="sub-table scrolldown" border="0">
                        <thead>
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    ...
                                    <option value="" disabled selected hidden>Choose Doctor Name from the list</option><br/>';
                                        ...
                                        $list11 = $database->query("select  * from  doctor where is_active = 1 order by docname asc;");
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="area" class="form-label">Scheduled Date: </label>
                                </td>
                            </tr> 
                            <tr>
                                <td class="label-td" colspan="2">
