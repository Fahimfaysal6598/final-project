...
<body>
    ...
    <tr class="menu-row" >
        <td class="menu-btn menu-icon-patient">
            <a href="request_doctor.php" class="non-style-link-menu"><div><p class="menu-text">Request Doctors</p></a></div>
        </td>
    </tr>
    <tr class="menu-row" >
        <td class="menu-btn menu-icon-patient">
            <a href="request_patient.php" class="non-style-link-menu"><div><p class="menu-text">Request Patients</p></a></div>
        </td>
    </tr>
    </table>
    </div>
    <div class="dash-body">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr>
                <td>
                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        <input  type="text" name="search" id="doctorSearch" class="input-text header-searchbar"
                            placeholder="Search Doctor name or Email" >

                        <?php
                                echo '<datalist id="doctors">';
                        $list11 = $database->query("SELECT docname, docemail FROM doctor WHERE is_active=1");
                    ...
                    <!-- <input type="search" name="search" id="doctorSearch" class="input-text header-searchbar" placeholder="Search Doctor name or Email" list="doctors"> -->
            ...
            if ($_POST) {
                ...
                $sqlmain = "SELECT * FROM doctor WHERE (docemail='$keyword' OR docname='$keyword' OR docname LIKE '$keyword%' OR docname LIKE '%$keyword' OR docname LIKE '%$keyword%') AND is_active=1";
            } else {
                $sqlmain = "SELECT * FROM doctor WHERE is_active=1 ORDER BY docid DESC";
            }
            ?>
                ...
                <td colspan="4">
                    <center>
                        <div class="abc scroll">
                            <table  id="data-table" width="100%" class="sub-table scrolldown" border="0">
                                <thead>
                                    <tr>
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                    <td> &nbsp;<div style="display: flex; align-items: center;">' . substr($name, 0, 30) . ' ' . (($row['is_active'] == 1) ? '<img src="../img/verified.png" style="margin-left: 5px;" title="verified">' : "") . '</div></td>
                                        <td>
                                        '.substr($email,0,20).'
                                        </td>
                                        <td>
            ...
            <div id="popup1" class="overlay" style="overflow: auto">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">NID PHOTO: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                  <img style="width: 100%;height: 200px" src="../' . $nid_photo . '" alt="">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                              <embed style="width: 100%; height: 300px;" src="../' . $certificate . '"" type="application/pdf">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="area" class="input-text" placeholder="Address" required><br>
                                </td>
                            </tr> 
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="clinic" class="input-text" placeholder="Clinic" required><br>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="activity" class="input-text" placeholder="Activity" required><br>
                                </td>
                            </tr>
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="area" class="input-text" placeholder="Address" value="'.$area.'" required><br>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="clinic" class="input-text" placeholder="Clinic" value="'.$clinic.'" required><br>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="activity" class="input-text" placeholder="Activity" value="'.$activity.'" required><br>
                                        </td>
                                    </tr>
