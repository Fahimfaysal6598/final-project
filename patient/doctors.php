...
<body>
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Doctor name or Specialties" list="doctors">&nbsp;&nbsp;
                            
                            <?php
                                echo '<datalist id="doctors">';
                                $list11 = $database->query("select  docname,specialties from  doctor;");
                ...
                <tr>
                   <td colspan="4">
                       <center>
                        <div class="abc scroll" style="padding:10px">
                        <table id="doctor-table" width="100%" class="sub-table scrolldown" border="0">
                        <thead>
                        <tr>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $error_1=$_GET["error"];
                $errorlist= array(
                    '1'=>'<label for="promoter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Already have an account for this Email address.</label>',
                    '2'=>'<label for="promoter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Password Conformation Error! Reconform Password</label>',
                    '3'=>'<label for="promoter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;"></label>',
                    '4'=>"",
                    '0'=>'',
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="activity" class="input-text" placeholder="Address" value="'.$activity.'" required><br>
                                        </td>
                                    </tr>
    ...
    include("../admin/js/js.php");

?>
</div>
<script>
    new DataTable('#doctor-table', {
        fixedHeader: true,
        responsive: true
    });
