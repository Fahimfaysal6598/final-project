...
<body>
    ...
    $sqlmain= "select appointment.appoid,schedule.scheduleid,schedule.title,doctor.docname,doctor.docclinic,doctor.docarea,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where  patient.pid=$userid ";
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No result found !</p>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                            ...
                                            <td style="width: 25%;">
                                                    <div  class="dashboard-items search-items"  >
                                                        ...
                                                        <div class="h3-search">
                                                                    ...
                                                                    Reference Number: RN-000-'.$appoid.'
                                                                </div>
                                                                <div class="h1-search">
                                                                ...
                                                                <div class="h3-search">
                                                                    Area: '.substr($docarea,0,30).'
                                                                </div>

                                                                <div class="h3-search">
                                                                    Clinic: '.substr($docclinic,0,30).'
                                                                </div>
