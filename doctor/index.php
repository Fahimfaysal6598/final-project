                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    <p class="profile-title"><?php echo substr($username,0,13). ' ' . (($userfetch['is_active'] == 1) ? '<img src="../img/verified.png" style="margin-left: 5px;" title="verified">' : "") ?></p>
                                ...
                                <td width="50%">
                                    ...
                                    <center>
                                        <table class="filter-container" style="border: none;" border="0">
                                            <tr>
                                                <td colspan="4">
                                                    <p style="font-size: 20px;font-weight:600;padding-left: 12px;">Doctor and Paitent Status</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 25%;">
